...
const TABS = [
  { label: 'Populares',      fetch: () => tmdbApi.getPopularTVShows() },
  { label: 'Mais Avaliadas', fetch: () => tmdbApi.getTopRatedTVShows() },
];
...
const Series = () => {
  ...
  return (
    <Page theme={theme}>
      <Inner>
      <PageHeader>
        <PageTitle theme={theme}>Séries</PageTitle>
        <PageSubtitle theme={theme}>Explore as melhores séries do momento</PageSubtitle>
      </PageHeader>
